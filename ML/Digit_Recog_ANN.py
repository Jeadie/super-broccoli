"""
~~~~~~~~~~
Implementation from @mnielsen as a part of his book "Neural Networks and Deep Learning". 
Ive included this as I have used it extensively to understand NN and SGD. I am also 
attempting to convert this into a C++ module. 
~~~~~~~~~~
Notes from Michael Nielsen
...
def load_data():
    ...
    print(type(training_data[1]), type(validation_data[0]), type(test_data[0]))
    f.close()
